...
@IonicPage()
@Component({
  selector: 'page-alertas-sin-vencer',
  templateUrl: 'alertas-sin-vencer.html',
})
export class AlertasSinVencerPage {
  ...
  irMenu(){
   ...
   load() : void
   {
    ...
    url       : any      	= this.baseURI + "alertasActuacionSinVencer.php";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AlertasSinVencerPage');
  }

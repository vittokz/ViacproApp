...
@IonicPage()
@Component({
  selector: 'page-alertas-dia',
  templateUrl: 'alertas-dia.html',
})
export class AlertasDiaPage {
  ...
  irMenu(){
   ...
   load() : void
   {
    ...
    url       : any      	= this.baseURI + "alertasActuacionDia.php";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AlertasDiaPage');
  }
